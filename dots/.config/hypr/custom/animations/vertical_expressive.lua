-- Generated from vertical_expressive.conf. Keep the legacy profile as migration provenance.
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 40, bezier = "standardDecel", style = "once" })
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 2, bezier = "menu_accel", style = "popin 94%" })
...
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 3, bezier = "emphasizedDecel", style = "slide" })
